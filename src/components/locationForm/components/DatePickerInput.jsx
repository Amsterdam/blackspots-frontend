...
const DatePickerInput = ({ name, onChange, initialValue }) => {
  ...
  useEffect(() => {
    setValue(initialValue ? stringToDate(initialValue) : null);
  }, [initialValue]);
...
DatePickerInput.propTypes = {
  ...
  initialValue: PropTypes.oneOfType([PropTypes.shape({}), PropTypes.string]),
};
